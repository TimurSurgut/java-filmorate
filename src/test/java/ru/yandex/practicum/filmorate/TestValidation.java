...
class TestValidation {
    ...
    void postFilmFilm() {
        ...
        assertEquals("Терминатор", inMemoryFilmStorage.findAll().get(2).getName(),
    ...
    void putFilm() {
        ...
        assertEquals("Блэйд", inMemoryFilmStorage.findAll().get(2).getName(),
    ...
    void postFilmUser() {
        ...
        assertEquals("login", inMemoryUserStorage.findAll().get(6).getName(),
    ...
    void putUser() {
        ...
        assertEquals("login", inMemoryUserStorage.findAll().get(1).getName(),
                "Имя должно быть login");
        //Проверка исключения при попытке добавить пользователя с датой рождения позже текущей;
        ...
        assertEquals("Василий", inMemoryUserStorage.findAll().get(1).getName(),
    ...
    void addFriend() {
        ...
        assertEquals(new ResponseEntity<>
                        (gson.toJson("Пользователь с id " + 2 + " успешно добавлен в друзья"), HttpStatus.OK), userService.addFriend(1, 2),
                "");
    }
